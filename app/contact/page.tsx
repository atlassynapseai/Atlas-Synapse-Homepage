    ...
    return (
      <div className="min-h-screen pt-32 pb-20 flex items-start justify-center px-4">
        <div className="max-w-md w-full rounded-2xl border border-white/10 bg-slate-900/60 p-10 text-center">
          ...
          <p className="text-slate-500 text-sm mb-6">A confirmation email has been sent to you.</p>
          ...
          <div className="rounded-2xl border border-white/10 bg-slate-900/60 p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-5" noValidate>
              ...
              <div>
                ...
                <div className="flex">
                  <select
                    ...
                    className="rounded-l-lg border border-r-0 border-white/10 bg-slate-800/80 px-2 py-2.5 text-sm text-slate-300 focus:outline-none focus:border-atlas-primary/50 hover:border-white/20 transition-all shrink-0"
                  >
                    {DIAL_CODES.map(d => (
                  ...
                  <input type="tel" value={form.phone} onChange={e => setField('phone', e.target.value)}
                    className="flex-1 rounded-r-lg border border-white/10 bg-slate-800/60 px-4 py-2.5 text-slate-100 placeholder-slate-500 transition-all hover:border-white/20 focus:border-atlas-primary/50 focus:outline-none"
              ...
              <div>
                ...
                <div
                  className={`relative rounded-lg border-2 border-dashed px-6 py-8 text-center transition-all cursor-pointer ${dragOver ? 'border-atlas-primary bg-atlas-primary/10' : 'border-white/15 bg-slate-800/30 hover:border-white/30 hover:bg-slate-800/50'}`}
                ...
                >
                  ...
                  <p className="text-sm text-slate-400">Drag & drop files here, or <span className="text-atlas-primary font-medium">browse</span></p>
